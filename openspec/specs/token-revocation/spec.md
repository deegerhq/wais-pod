...
Define how agent platforms publish revocation lists and how websites consume them to reject tokens that have been revoked before their natural expiration.
...
- **THEN** the RevocationList SHALL clamp the value to 60
